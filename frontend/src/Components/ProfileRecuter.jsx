...
import NavbarProfile1 from './NavbarProfile1';
import SideBarRecuter from './SideBarRecuter';
import SideBar2 from './SideBar2';

const ProfileRecuter = () => {
  const data = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-[#000000] md:pt-20 sm:pt-[4rem] sm:p-8 relative">
      <div className='absolute left-[-6rem] top-0'>
      <NavbarProfile1/>
      </div>
      ...
      <div className="fixed w-16 ml-[-1.9rem] md:ml-[-7rem] md:w-64 h-full bg-[#111827] text-white">
        ...
        <div className="my-6 bg-white mx-6 w-full h-[90%] rounded-xl shadow-md shadow-black md:px-3 flex items-center justify-between">
          ...
          <div className="text-black w-[80%] h-full py-20 px-2">
            <p className="text-xl flex items-center gap-2">
              Shivam Thapa <Link to='/profile2' className="cursor-pointer"><CiEdit /></Link>
            </p>
